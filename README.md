...
#### Download Snapshots
```
wget --load-cookies /tmp/cookies.txt "https://drive.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://drive.google.com/uc?export=download&id=1RRVly-d2Tp0zbV6mm_DZWxiC0Ht0JF7f' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1RRVly-d2Tp0zbV6mm_DZWxiC0Ht0JF7f" -O blockchain.zip && rm -rf /tmp/cookies.txt
```
